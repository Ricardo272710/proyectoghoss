...
const smsOwner = () => { return `\`\`\`𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼𝗹𝗼 𝗺𝗶 𝗰𝗿𝗲𝗮𝗱𝗼𝗿 𝗹𝗼 𝗽𝘂𝗲𝗱𝗲 𝘂𝘀𝗮𝗿\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼𝗹𝗼 𝗮𝗱𝗺𝗶𝗻𝘀 𝘆 𝗺𝗶 𝗰𝗿𝗲𝗮𝗱𝗼𝗿 𝗹𝗼 𝗽𝘂𝗲𝗱𝗲 𝘂𝘀𝗮𝗿\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`𝗦𝗼𝗹𝗼 𝘂𝘀𝘂𝗮𝗿𝗶𝗼𝘀 𝗽𝗿𝗲𝗺𝗶𝘂𝗺 𝗹𝗼 𝗽𝘂𝗲𝗱𝗲𝗻 𝘂𝘀𝗮𝗿\`\`\`` }//USUARIOS PREMIUM
const smsGroup = () => { return `\`\`\`𝗦𝗼𝗹𝗼 𝘀𝗲 𝗽𝘂𝗲𝗱𝗲 𝘂𝘀𝗮𝗿 𝗲𝗻 𝗹𝗼𝘀 𝗴𝗿𝘂𝗽𝗼𝘀\`\`\`` }//PARA GRUPOS
const smsPrivate = () => { return `\`\`\`𝗦𝗼𝗹𝗼 𝘀𝗲 𝗽𝘂𝗲𝗱𝗲 𝘂𝘀𝗮𝗿 𝗲𝗻 𝗲𝗹 𝗽𝗿𝗶𝘃𝗮𝗱𝗼 𝗱𝗲𝗹 𝗯𝗼𝘁\`\`\`` }//AL PRIVADO
const smsAdmin = () => { return `\`\`\`𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼𝗹𝗼 𝗽𝗮𝗿𝗮 𝗮𝗱𝗺𝗶𝗻𝘀\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`𝗡𝗲𝗰𝗲𝘀𝗶𝘁𝗼 𝘀𝗲𝗿 𝗮𝗱𝗺𝗶𝗻 𝗽𝗮𝗿𝗮 𝗾𝘂𝗲 𝗽𝘂𝗲𝗱𝗮𝘀 𝘂𝘀𝗮𝗿 𝗲𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼\`\`\`` }//BOT CON ADMIN
const smsUnreg = () => { return `\`\`\`𝗡𝗲𝗰𝗲𝘀𝗶𝘁𝗮𝘀 𝗲𝘀𝘁𝗮𝗿 𝗿𝗲𝗴𝗶𝘀𝘁𝗿𝗮𝗱𝗼\`\`\`` }//VERIFICAR
const smsRestrict = () => { return `\`\`\`𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝗺𝗶 𝗰𝗿𝗲𝗮𝗱𝗼𝗿 𝗹𝗼 𝗽𝗿𝗼𝗵𝗶𝗯𝗶𝗼\`\`\`` }//RESTRINGIR COMANDO
...
//main.js
const smsWelcome = () => { return '*╭━〔 𝘽𝙊𝙈𝘽𝙊𝙉 𝘽𝙊𝙏 〕━⬣\n*┃ Bienvenido Al Mejor Grupo De WhatsApp 👤\n┃ Nombre Del Grupo: @subject*\n*┃ Nuevo Usuario: @user*\n*╰━━━━━━━━━━━━⬣*'}
const smsBye = () => { return '*╭━〔 𝘽𝙊𝙈𝘽𝙊𝙉 𝘽𝙊𝙏 〕━⬣\n┃ Nadie Te Necesitaba En El Grupo , Adios 👤\n┃ Nuevo Usuario: @user*\n*╰━━━━━━━━━━━━⬣*'}
const smsSpromote = () => { return '𝘽𝙊𝙈𝘽𝙊𝙉 𝘽𝙊𝙏 𝗟𝗲 𝗗𝗶𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
const smsSdemote = () => { return '𝘽𝙊𝙈𝘽𝙊𝙉 𝘽𝙊𝙏 𝗟𝗲 𝗤𝘂𝗶𝘁𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
...
//_allantilink.js
const smsTextoYT = () => { return '〔 𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁 〕'} 
...
const smsCont18 = () => { return `𝗘𝘂 𝘀𝗮𝗯𝗶𝗮𝘀 𝗾𝘂𝗲 𝗲𝘀𝘁𝗮 𝗽𝗿𝗼𝗵𝗶𝗯𝗶𝗱𝗼 𝗹𝗹𝗮𝗺𝗮𝗿 𝗮𝗹 𝗯𝗼𝘁 ?`}
...
const eGataCoins = () => { return '🐱 DragonCoins' }
const eGataTickers = () => { return '🎫 DragonTickers' } 
...
const smsModAd2 = () => { return `Solo los Admins podrán usar Dragon Bot en Grupos`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙊𝙋𝙏𝙄𝙈𝙐𝙎 𝘽𝙊𝙏!! 😸\n\n💖 𝙊𝙋𝙏𝙄𝙈𝙐𝙎 𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
