...
const smsSpromote = () => { return '𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 𝗟𝗲 𝗗𝗶𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
const smsSdemote = () => { return '𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 𝗟𝗲 𝗤𝘂𝗶𝘁𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
...
//_allantilink.js
const smsTextoYT = () => { return '〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕'} 
...
const eGataCoins = () => { return '🐱 OptimusCoins' }
const eGataTickers = () => { return '🎫 OptimusTickers' } 
...
const smsModAd2 = () => { return `Solo los Admins podrán usar Optimus Bot en Grupos`}
