...
await conn.sendMessage(res, { text: text + ( users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' ), mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fkontak })
await delay(3 * 3000)
await conn.sendMessage(res2, { text: text + ( users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' || users == 51902360712 ? '\n\n_atte. 〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕_' : '' ), mentions: (await conn.groupMetadata(`${res2}`)).participants.map(v => v.id) }, { quoted: fkontak })
